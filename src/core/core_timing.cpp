...
void Timing::Timer::Advance() {
    ...
    // DSP HLE runs nested inside this loop and has its own Begin/EndDSPProcessing bracket;
    // perf_stats.cpp reports core_timing exclusive of dsp_hle so buckets don't double-count.
